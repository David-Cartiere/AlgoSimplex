...
$(document).ready(function() {
    ...
    $("#findSimplex").click(function() {
       ...
       alert("index critere(1) : " + indexCritere1);
       alert("index critere(2) : " + indexCritere2);
       ...
       calculCj();
        ...
        var indexCritere1= calculCj(); // retourne premier critère 
        var indexCritere2= minRatio(grille_base, indexCritere1); // retourne deuxieme critere 

        alert(minRatio(grille_base, indexCritere1));
      
        // alert(getValeurPivot(grille_base, indexCritere1, indexCritere2));
    });
...
//     console.log("critere(2) de la fonction" + critere_2);
//     return critere_2; 
...
// ---- calcul critere 2 
function minRatio(grille, critere_1) {

    var nbLignes = $("#txtNbContraintes").val();
    var ratios = [];
    var min_ratio;

    for (i = 0; i < nbLignes; i++)
        ratios.push(grille[nbLignes][critere_1]);
        
     min_ratio = Math.min.apply(Math, ratios);
    ...
    //     //  ratio = grille[nbVariables][critere_1] / $("#valeur_contrainte_" + i).val();
...
// function getValeurPivot(indexLigne, indexColonne){
function getValeurPivot(grille, indexCritere1, indexCritere2){
    ...
    valeur_pivot = grille[indexCritere1][indexCritere2]; 
